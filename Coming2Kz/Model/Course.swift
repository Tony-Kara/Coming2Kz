...
var courses = [
    Course(title: "English Teacher's loudge", subtitle: "Connect with professional English Teachers, get access to marterials and watch live presentations", caption: "5 sections - 3 hours", color: Color(hex: "7850F0"), image: Image("teacher2")),
